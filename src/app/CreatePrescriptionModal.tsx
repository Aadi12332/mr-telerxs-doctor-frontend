  ...
  return (
    <div className="fixed inset-0 z-50">
      <div className="bg-white w-full lg:p-8 p-3 relative h-svh overflow-auto scroll-hide !pt-20">
        ...
        <div className="bg-[#E6F5FD] lg:rounded-[20px] rounded-lg lg:p-8 p-3">
          ...
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-8">
            ...
            <div>
              <p className="text-base lg:text-[20px] text-[#00000080] mb-2">
                Medicine Name
              </p>
              <input
            ...
            <div>
              <p className="text-base lg:text-[20px] text-[#00000080] mb-2">Dosage</p>
              <input
            ...
            <div>
              <p className="text-base lg:text-[20px] text-[#00000080] mb-2">Duration</p>
              <input
...
<div>
  ...
  />
        ...
        <div className="flex justify-between sm:gap-6 gap-2 mt-8">
          <button onClick={()=>{navigate("/prescription-management");onClose();}} className="flex items-center justify-center gap-3 h-[48px] lg:h-[77px] w-full rounded-lg px-2 lg:rounded-[20px] text-base lg:text-[26px] font-medium text-white bg-[linear-gradient(90deg,#25AEED_0%,#0A70A7_100%)]">
