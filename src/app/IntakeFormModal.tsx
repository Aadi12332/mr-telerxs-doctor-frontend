...
export default function IntakeFormModal({ onClose }: Props) {
  const [dob, setDob] = useState<any>(null);

  return (
    <div className="fixed inset-0 z-50">
      <div className="bg-[#80A2B5] w-full relative h-svh overflow-auto scroll-hide py-20">
        <button onClick={onClose} className="absolute left-6 top-6 text-2xl">
