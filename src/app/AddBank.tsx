        ...
        <div className="space-y-6 mb-8">
          ...
          {step === 1 && (
            <div className="border border-[#0000004D] lg:rounded-[20px] rounded-lg lg:p-6 p-3 space-y-6">
              <div>
                <label className="block lg:mb-3 mb-1 lg:text-[22px] sm:text-lg text-base">Account Holder Name</label>
                <input className="w-full border border-[#0000004D] lg:text-[20px] text-base lg:rounded-[20px] rounded-lg lg:h-[65px] h-10 px-4 py-3" placeholder="John" />
                <p className="text-[#00000080] lg:lg:text-[20px] sm:text-base text-sm lg:mt-3 mt-1">Enter the full name as it appears on your bank account</p>
              </div>

              <div>
                <label className="block lg:mb-3 mb-1 lg:text-[22px] sm:text-lg text-base">Bank Name</label>
                <input className="w-full border border-[#0000004D] lg:rounded-[20px] rounded-lg lg:text-[20px] text-base lg:h-[65px] h-10 px-4 py-3" placeholder="Chase Bank" />
              </div>
          ...
          {step === 2 && (
            <div className="border border-[#0000004D] lg:rounded-[20px] rounded-lg lg:p-6 p-3 space-y-6">
              <div>
                <label className="block lg:mb-3 mb-1 lg:text-[22px] sm:text-lg text-base">Account Number</label>
                <input className="w-full border border-[#0000004D] rounded-lg lg:rounded-[20px] lg:text-[20px] text-base h-10 lg:h-[65px] px-4 py-3" placeholder="Account Number" />
              </div>

              <div>
                <label className="block lg:mb-3 mb-1 lg:text-[22px] sm:text-lg text-base">Confirm Account Number</label>
                <input className="w-full border border-[#0000004D] rounded-lg lg:rounded-[20px] lg:text-[20px] text-base h-10 lg:h-[65px] px-4 py-3" placeholder="Confirm Account Number" />
              </div>

              <div>
                <label className="block lg:mb-3 mb-1 lg:text-[22px] sm:text-lg text-base">
                  Routing Number (ABA / IFSC / Swift)
                </label>
                <input
                  className="w-full border border-[#0000004D] rounded-lg lg:rounded-[20px] lg:text-[20px] text-base h-10 lg:h-[65px] px-4 py-3"
                  placeholder="Enter routing number"
                />
                <p className="text-[#00000080] lg:text-[20px] sm:text-base text-sm lg:mt-3 mt-1">
          ...
          {step === 3 && (
            ...
            <div className="border border-[#0000004D] rounded-lg lg:rounded-[20px] lg:p-6 p-3 space-y-6">
              <h2 className="lg:text-[26px] text-xl font-semibold">Review Your Information</h2>

              <div className="grid grid-cols-2 gap-6">
                <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Account Holder</p>
                <p className="lg:text-[22px] sm:text-lg text-base text-end">John</p>

                <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Bank Name</p>
                <p className="lg:text-[22px] sm:text-lg text-base text-end">Chase Bank</p>

                <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Account Number</p>
                <p className="lg:text-[22px] sm:text-lg text-base text-end">**** **** **** 4892</p>

                <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Routing Number</p>
                <p className="lg:text-[22px] sm:text-lg text-base text-end">12334567</p>
              </div>
            ...
            <>
              <div className="border border-[#0000004D] rounded-lg lg:rounded-[20px] lg:p-8 p-3 text-center space-y-6">
                <div className="grid grid-cols-2 gap-6 text-left">
                  <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Account Holder</p>
                  <p className="text-[#000000] lg:text-[22px] sm:text-lg text-base text-end">John</p>

                  <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Bank Name</p>
                  <p className="text-[#000000] lg:text-[22px] sm:text-lg text-base text-end">Chase Bank</p>

                  <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Account Number</p>
                  <p className="text-[#000000] lg:text-[22px] sm:text-lg text-base text-end">
                    **** **** **** 4892
                  </p>

                  <p className="text-[#000000B2] lg:text-[22px] sm:text-lg text-base">Routing Number</p>
                  <p className="text-[#000000] lg:text-[22px] sm:text-lg text-base text-end">12334567</p>
                </div>
              </div>
